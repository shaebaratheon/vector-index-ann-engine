"""Subsystem search_router implementation for vector-index-ann-engine."""
...
class SearchRouterEngine:
    def __init__(self, config: Optional[SearchRouterConfig] = None):
    ...
    def process_request(self, ctx: SearchRouterContext) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError(f'Execution failure in search_router: {ex}') from ex
