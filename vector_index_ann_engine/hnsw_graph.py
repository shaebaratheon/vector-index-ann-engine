"""Subsystem hnsw_graph implementation for vector-index-ann-engine."""
...
class HnswGraphEngine:
    def __init__(self, config: Optional[HnswGraphConfig] = None):
        self.config = config or HnswGraphConfig()
    ...
    def process_request(self, ctx: HnswGraphContext) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError(f'Execution failure in hnsw_graph: {ex}') from ex
