// Feature implementation: feat: implement 8-bit asymmetric product quantization codec
// Repository: vector-index-ann-engine

/* Production-ready implementation of feature/product-quantization-codec. */
